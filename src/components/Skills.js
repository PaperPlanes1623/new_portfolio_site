...
const Skills = () => {
  ...
  let languages = ['Javascript', 'PHP', 'Ruby', 'C#', 'Java'];
  let frameworks = ['React', 'Rails', 'Laravel', 'ASP.NET'];
  let otherSkills = ['Wordpress', 'Git', 'Jest', 'Rspec', 'node.js'];
  ...
  return (
    <section className="skills" id="skills">
      ...
      <div className="flex-container">
        ...
        <div className="skill-icons" id="react"><Icon name="react icon" size="huge" style={{ color: 'lightblue' }} /></div>
